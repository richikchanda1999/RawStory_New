...
class NotificationWorks {
  ...
  Future<List<NotificationModel>> getNotifications() async {
    ...
    for (var i in item) {
      ...
      String imgUrl = i.getElement('media:content').getAttribute('url');
      nmList.add(NotificationModel(title, desc, shareUrl, dateTime,
          imgUrl: imgUrl, creator: creator));
    }
...
class NotificationModel {
  NotificationModel(this.title, this.desc, this.shareUrl, this.dateTime,
      {this.imgUrl, this.creator});
  String title;
  String desc;
  String shareUrl;
  String dateTime;
...
class PostFromNotification extends StatelessWidget with PostPageStyle {
  PostFromNotification({this.notificationModel, this.isDark});
  final bool isDark;
                            ...
                            children: [
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          ...
                                          RichText(
                                            ...
                                            TextSpan(
                                              text:
                                                  " ${this.notificationModel.creator}",
                                              style: TextStyle(
                                                  color: snapshot.hasData &&
                                                          snapshot.data
                                                      ? Colors.white
                              ...
                              Expanded(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    launchTwitter(
                                        this.notificationModel.shareUrl);
                                  },
                                  child: Container(
                                    child: Image.asset(
